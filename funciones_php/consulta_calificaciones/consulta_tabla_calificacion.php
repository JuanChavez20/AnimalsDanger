...
<table class="table table-hover text-center">
	...
	<tbody>
	<?php  
	$sql = "SELECT * FROM  parcial2 WHERE materia='Aplicaciones web'  ";
	...
	<td><a href="#!"  data-target="#editAlumnoModal" data-toggle="modal" class="edit" data-idd='<?php echo $fila['id_student']; ?>'data-apllm='<?php echo $fila['calificacion']; ?>' data-tell='<?php echo $fila['competencia']; ?>'><i class="btn btn-info btn-raised btn-sm"  title="actualizar"> Registrar</i></a></td>
